...
!!! info
    ...
    **Source Code Repository:** [https://github.com/rhdh-JslYoon-org/audio-to-text-sep16-4](https://github.com/rhdh-JslYoon-org/audio-to-text-sep16-4)

    **GitOps Repository:** [https://github.com/rhdh-JslYoon-org/audio-to-text-sep16-4-gitops](https://github.com/rhdh-JslYoon-org/audio-to-text-sep16-4-gitops)

# **Usage**

To access the audio-to-text-sep16-4 application that was deployed using the Software Template, complete the following instructions:
